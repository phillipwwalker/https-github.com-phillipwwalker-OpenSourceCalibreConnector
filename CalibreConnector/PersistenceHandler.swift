        ...
        do {
            ...
            if (result.count < 1){
                ...
                for data in result as! [NSManagedObject]
                {
                    ...
                    newSetting.setValue(bookStore.titleSort, forKey: "titleSort")
                    newSetting.setValue(bookStore.authorSort, forKey: "authorSort")
                    newSetting.setValue(bookStore.seriesSort, forKey: "seriesSort")
                    newSetting.setValue(bookStore.categorySort, forKey: "categorySort")
                    ...
                    newSetting.titleSort = bookStore.titleSort
                    newSetting.authorSort = bookStore.authorSort
                    newSetting.seriesSort = bookStore.seriesSort
                    newSetting.categorySort = bookStore.categorySort
                    try context.save()
    ...
    func readSettings(bookStore: BookStore){
        ...
        do {
            ...
            for data in result as! [NSManagedObject]
            {
                ...
                print("titleSort=",settingsEntity.titleSort ?? "")
                print("authorSort=",settingsEntity.authorSort ?? "")
                print("seriesSort=",settingsEntity.seriesSort ?? "")
                print("categorySort=",settingsEntity.categorySort ?? "")
                ...
                bookStore.titleSort = settingsEntity.titleSort ?? ""
                bookStore.authorSort = settingsEntity.authorSort ?? ""
                bookStore.seriesSort = settingsEntity.seriesSort ?? ""
                bookStore.categorySort = settingsEntity.categorySort ?? ""

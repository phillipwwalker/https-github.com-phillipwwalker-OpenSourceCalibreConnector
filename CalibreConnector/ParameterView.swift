            ...
            HStack(content:{
                ...
                Button( action:
                    ...
                    Task {
                        ...
                        curentLibrary = bookStore.curLibrary
                        defaultLibrary = bookStore.defaultLibrary
                        print("libraryList",libraryList)
                        print("curentLibrary:",curentLibrary)
                ...
                , label: {
                    Text("Load Libraries").foregroundColor(.black)
                }).overlay(
                    RoundedRectangle(cornerRadius: 20)
                        .stroke(Color.black, lineWidth: 2)
                )
                Button(action: {
                    ...
                    gModel.bookStore.calibreServer = progressVariables.server
